...
const ProposedActions = () => {
  ...
  return (
    ...
    >
      ...
      {/*<div className="text-white-main text-base lg:text-lg font-[800] ml-auto mt-4 flex items-center justify-center gap-2 rounded-full border-2 border-solid border-white-main px-4 py-[5px] cursor-pointer hover:bg-white-main/5 transition-all durration-300">*/}
