...
const SharedFeatureSection: React.FC<IProps> = ({
  ...
  return (
    <>
      <section className="w-full flex flex-col items-center justify-start gap-2 mt-6 px-4 md:px-14 pt-12 pb-3 bg-gray-200">
        <div
          className={cn(
        ...
        >
          {/* Col 1 */}
          <StackedCarousel
            containerClasses={colOneClasses}
            images={data?.images}
          />
          {/* Col 2 */}
          <div
          ...
          >
            <div className="w-full flex flex-col items-start justify-start">
              ...
              <p className="base font-semibold text-neutral-600 text-left">
                {data?.body}
              </p>
            </div>
        ...
        {/*<div className="text-black-800 text-base lg:text-lg font-[800] ml-auto mt-4 flex items-center justify-center gap-2 rounded-full border-2 border-solid border-black-800 px-4 py-[5px] cursor-pointer hover:bg-black-800/5 transition-all durration-300">*/}
