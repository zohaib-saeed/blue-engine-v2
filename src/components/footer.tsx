    ...
    <footer className="bg-[#0F0F0F]">
      <div className="grid grid-cols-2 items-center pb-12  py-4 mx-auto 2xl:w-[50%] w-[90%]">
        <div className="flex gap-4 items-center">
          <h2 className="md:text-[48px] text-2xl font-NunitoExtraBold text-white">Sync 8</h2>
      ...
      <div className="grid  2xl:w-[50%] w-[90%]  mx-auto grid-cols-12 ">
        ...
        <div className="grid gap-2 grid-cols-12">
          ...
          <div className="grid  gap-2 items-center grid-cols-12 lg:mb-10">
            {/* <div className="col-span-2">
              <img src={phonevolume} alt="" className="w-[30px]"/>
            </div> */}
            <div className="col-span-10">
              ...
              Meerlandenweg 65B  <br/> 1187ZR Amstelveen <br/> <br/><span className="font-NunitoExtraBold">KVK</span> 86947273 <br/><span className="font-NunitoExtraBold">BTW</span> NL864155372BO1
              </p>
            </div>
          </div>
        ...
        {/* <div className="sm:col-span-3 col-span-12 md:mx-auto">
          <h2 className="font-NunitoExtraBold lg:text-[22px] sm:text-[18px] text-[16px]  text-white sm:pb-5 pb-1">
            Follow Us
          </h2>
          <ul className="flex pt-2 sm:space-x-6 space-x-1">
            <li>
              <img src={facebookappsymbol} alt="" className="cursor-pointer sm:w-[80%] w-[70%]" />
            </li>
            <li>
              <img src={twitter} alt="" className="cursor-pointer sm:w-[80%] w-[70%]"/>
            </li>
            <li>
              <img src={instagram} alt="" className="cursor-pointer sm:w-[80%] w-[70%]"/>
            </li>
      ...
      <div className="text-center py-4">
        <p className="text-[#CECECE] text-[9px] font-NunitoRegular">COPYRIGHT © 2023  ALL RIGHTS RESERVED.</p>
      </div>
    </footer>
  );
};
